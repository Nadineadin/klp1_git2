...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm py-3">
  ...
  <div class="collapse navbar-collapse" id="mainNav">
    <ul class="navbar-nav ms-auto fw-semibold">
      ...
      <li class="nav-item"><a class="nav-link text-uppercase " href="<?= $base_url ?>model/redirected.php">dashboard</a></li>
      <?php else:  ?>
      <li class="nav-item"><a class="nav-link text-uppercase" href="<?= $base_url ?>pages/login.php">login</a></li>
      <?php endif; ?>
    </ul>
  </div>
</div>
